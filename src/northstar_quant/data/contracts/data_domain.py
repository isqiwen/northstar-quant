...
from northstar_quant.foundation.config.data_sources import data_source_config_sha256

if TYPE_CHECKING:
    from northstar_quant.foundation.config.data_sources import DataSourceConfig
