...
def build_rebalance_plan(targets: pl.DataFrame, positions: list[PositionSnapshot], latest_prices: dict[str, float], equity: float | None = None) -> list[RebalanceOrderPlan]:
    """根据目标权重与真实持仓生成再平衡计划。
