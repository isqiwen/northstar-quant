"""Install private configuration from SSH stdin; replace only when explicitly requested."""
...
def install(path: Path, content: bytes, *, replace: bool = False) -> None:
