...
Verified default-branch anchors: Data Hub `296d53b`, Market Intelligence
...
| --- | --- | --- | --- |
| [quant-data-hub](https://github.com/isqiwen/quant-data-hub) | Canonical structured/reference data, lineage, quality evidence, immutable dataset snapshots and delivery. | Executable FastAPI/PostgreSQL module. Annotated [release `v0.9.1`](https://github.com/isqiwen/quant-data-hub/releases/tag/v0.9.1) identifies exact default-branch commit `296d53b` and publishes the supported cross-repository contract inventory; package, OpenAPI and release identity are aligned. Manifests/membership are append-only and drift-fail-closed, but complete observation revision/supersession remains `R1-DH-02` work. | Factors, strategies, simulation, portfolio risk, orders. |
