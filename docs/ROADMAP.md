...
| 5 | [#31 具体柜台仿真只读连接、账户与行情核对](https://github.com/isqiwen/northstar-quant/issues/31) | —；可独立开发，实际连接需仿真账号 |
...
#17 仍按其原范围交付；托管原文等新能力未实现前不能计入已完成事项。
...
没有外部账号时可先完成 #24、#36 与接入实现中的独立开发；不得用文件或内部 Paper 替代 #31/#32
