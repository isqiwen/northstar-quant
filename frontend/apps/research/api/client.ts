...
export type GetPath = `/api/strategy-definitions/${string}` | `/api/datasets/${string}/lineage` | `/api/factor-definitions/${string}` | `/api/strategy-versions/${string}` | `/api/factor-runs/${string}` | `/api/configuration-defaults` | `/api/datasets/${string}` | `/api/strategy-candidates` | `/api/paper/${string}` | `/api/research-attempts` | `/api/strategy-versions` | `/api/factor-revisions` | `/api/browser-session` | `/api/configurations` | `/api/runs/${string}` | `/api/factor-runs` | `/api/datasets` | `/api/catalog` | `/api/paper` | `/api/runs`;
...
export type CommandPath = `/api/factor-revisions/${string}/annotations` | `/api/strategy-versions/${string}/publish` | `/api/paper/${string}/advance` | `/api/strategy-versions` | `/api/factor-revisions` | `/api/run-comparisons` | `/api/configurations` | `/api/factor-runs` | `/api/paper` | `/api/runs`;
...
P extends `/api/paper` ? messages.PaperSession :
P extends `/api/runs` ? messages.RunCreated : never;
...
P extends `/api/paper` ? messages.PaperRequest :
P extends `/api/runs` ? messages.RunRequest : never;
