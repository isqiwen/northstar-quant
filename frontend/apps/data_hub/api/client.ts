...
export type CommandPath = `/api/explorer/compactions/${string}/export` | `/api/explorer/compactions/${string}/query` | `/api/research-inputs/assemble` | `/api/sync/contracts/review` | `/api/explorer/compactions` | `/api/explorer/instrument` | `/api/explorer/available` | `/api/explorer/contracts` | `/api/explorer/versions` | `/api/explorer/coverage` | `/api/explorer/compare` | `/api/research-inputs` | `/api/explorer/export` | `/api/explorer/select` | `/api/sync/jobs/query` | `/api/explorer/query` | `/api/explorer/chart` | `/api/sync/reprocess` | `/api/explorer/open` | `/api/sync/settings` | `/api/sync/token` | `/api/logout` | `/api/setup` | `/api/login`;
