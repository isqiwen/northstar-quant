...
export type GetPath = `/api/datasets/${string}/lineage` | `/api/datasets/${string}` | `/api/attempts/${string}` | `/api/sources/${string}` | `/api/sync/${string}` | `/api/processing/status` | `/api/browser-session` | `/api/rejections` | `/api/attempts` | `/api/datasets` | `/api/sources` | `/api/sync`;
...
P extends `/api/sync/${string}` ? messages.SyncJob :
...
P extends `/api/sync` ? messages.GetApiSyncResponse : never;
export type CommandPath = `/api/sources/${string}/reprocess` | `/api/sync/tushare` | `/api/import`;
export type CommandResponse<P> = P extends `/api/sources/${string}/reprocess` ? messages.ProcessingAttempt :
P extends `/api/sync/tushare` ? messages.SyncJob :
...
P extends `/api/sync/tushare` ? messages.SyncRequest :
