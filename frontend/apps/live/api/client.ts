...
P extends `/api/streams/${string}/closing-orders` ? messages.CommandRecord :
...
P extends `/api/streams/${string}/refresh-account` ? messages.AccountQueryRequest :
...
P extends `/api/streams/${string}/closing-orders` ? messages.ClosingOrderRequest :
