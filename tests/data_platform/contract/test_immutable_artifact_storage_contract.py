...
STORE_PATH = (
    PROJECT_ROOT / "src" / "northstar_quant" / "data_platform" / "artifacts" / "immutable_store.py"
)
...
def test_artifacts_package_does_not_reexport_store_and_create_domain_import_cycle() -> None:
    ...
    assert "northstar_quant.data_platform.artifacts.immutable_store" not in imported_modules
