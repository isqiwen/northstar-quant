...
def test_rulebook_is_data_only_and_cannot_load_static_or_live_rules() -> None:
    ...
    assert "northstar_quant.data.contracts.contract_master_loader" not in imported_modules
