...
from northstar_quant.data.market.pit import MarketDataPITSelector
from tests.helpers.paths import PROJECT_ROOT


PIT_MODULE = PROJECT_ROOT / "src" / "northstar_quant" / "data" / "market" / "pit.py"
...
def test_pit_module_only_depends_on_data_and_standard_library() -> None:
