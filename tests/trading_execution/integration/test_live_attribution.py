...
from northstar_quant.application import live_service


def test_recent_trade_attributions_returns_serializable_rows(
    monkeypatch,
...
def test_recent_account_attributions_returns_serializable_rows(
    monkeypatch,
    postgresql_session_factory,
):
    testing_session = postgresql_session_factory
...
def test_recent_anomaly_events_returns_serializable_rows(
    monkeypatch,
    postgresql_session_factory,
):
    testing_session = postgresql_session_factory
...
def test_recent_run_health_and_soak_summary_return_serializable_rows(
    monkeypatch,
    postgresql_session_factory,
):
    testing_session = postgresql_session_factory
